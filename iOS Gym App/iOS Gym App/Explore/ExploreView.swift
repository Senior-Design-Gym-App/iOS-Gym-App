    ...
    var body: some View {
        LazyVGrid(columns: columns, spacing: 16) {
            ...
            NavigationLink(destination: { AccountEditView() }, label: {
                ExploreCard(title: "Edit Account", subtitle: "Profile & settings", systemImage: "pencil.and.outline")
            })
            NavigationLink(destination: { UserProfileView(username: "demo_user") }, label: {
